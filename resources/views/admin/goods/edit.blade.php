    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding" v-show="tab==1">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" placeholder="商品库存" class="form-control" name="goods_number" value="{{$info->goods_number}}" />
                    </div>
                    <label class="col-sm-2 control-label">库存报警</label>
                    <div class="col-sm-4">
                        <input type="text" placeholder="库存报警" class="form-control" name="warn_number" value="{{$info->warn_number}}" />
                    </div>
                </div>
