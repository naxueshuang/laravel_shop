                ...
                <table class="table table-primary  mb30">
                    ...
                    @foreach($position as $val)
                        <tr>
                            ...
                            <td>{{$val->position_desc}}</td>
                            <td>
                                <a class="btn btn-sm btn-success" href="/admin/position/edit/{{$val['id']}}">编辑</a>
                                <a class="btn btn-sm btn-danger" href="/admin/position/del/{{$val['id']}}">删除</a>
                            </td>
                        </tr>
                        @endforeach
                    @endif
