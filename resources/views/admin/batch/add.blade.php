...
@section('pageHeader')
    <div class="pageheader">
        <h2><i class="fa fa-home"></i> 添加批次详情 <span>Subtitle goes here...</span></h2>
...
@section('content')
    ...
    <div id="goods_add">
    <p>
        <button :class="tab == 1 ? 'btn btn-sm btn-success': 'btn btn-sm btn-danger' " data-tab="1" data-title="发送红包" @click="switchTab">发送红包</button>&nbsp;
        <button :class="tab == 2 ? 'btn btn-sm btn-success': 'btn btn-sm btn-danger'" data-tab="2" data-title="发送短信"  @click="switchTab">发送短信</button>&nbsp;
        <button :class="tab == 3 ? 'btn btn-sm btn-success': 'btn btn-sm btn-danger'" data-tab="3"  data-title="发送邮件" @click="switchTab">发送邮件</button>&nbsp;
    </p>
    <!--标签切换-->
        ...
        <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3">
                            <button class="btn btn-primary btn-danger" id="btn-save">保存批次啊</button>&nbsp;
                        </div>
                    </div>
                </div><!-- panel-footer -->
        </form>
